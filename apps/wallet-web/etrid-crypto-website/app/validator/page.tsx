...
const ValidatorOnboardingContent = dynamic(
  () => import('./ValidatorOnboardingContent'),
  {
    ssr: false,
    loading: () => (
  ...
  return (
    <QueryProvider>
      <div className="min-h-screen gradient-bg-animated">
        <PageHeader title="Validator" subtitle="Become a network validator" />
        <ValidatorOnboardingContent />
      </div>
    </QueryProvider>
  )
}
