  ...
  return (
    <section className="py-20 px-4 max-w-7xl mx-auto bg-zinc-900/50">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-zinc-400">Real-time metrics from the ÉTRID Lightning Network</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <motion.div
          className="bg-zinc-900 rounded-xl p-6 border border-purple-500/20 text-center hover:shadow-lg hover:shadow-purple-500/20"
          whileInView={{ opacity: 1, y: 0 }}
          initial={{ opacity: 0, y: 20 }}
          viewport={{ once: true }}
        >
          <div className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent mb-2">
            ${formatNumber(stats.tvl / 1000000)}M
          </div>
          <div className="text-zinc-400">Total Value Locked</div>
        </motion.div>
        ...
        >
          <div className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent mb-2">
            {formatNumber(stats.transactions)}M
          </div>
          <div className="text-zinc-400">Total Transactions</div>
        </motion.div>
        ...
        >
          ...
          <div className="text-zinc-400">Average Fee</div>
        </motion.div>
      </div>
    </section>
  );
