...
import type { ValidatorSettings } from '@/types/validator';
import { formatCommission } from '@/lib/validator/format';
    ...
    <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-md overflow-hidden">
      <div className="p-6 border-b border-gray-200 dark:border-zinc-800">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Commission Settings</h2>
        ...
        {showSuccess && (
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700 dark:text-green-500">Settings updated successfully</p>
            </div>
          </div>
        )}
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-gray-500 dark:text-zinc-500">0%</span>
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="w-20 px-2 py-1 text-center border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-900 dark:text-white rounded focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent"
                  />
                  <span className="text-sm font-semibold text-gray-700 dark:text-zinc-300">%</span>
                </div>
                <span className="text-xs text-gray-500 dark:text-zinc-500">100%</span>
              </div>
            </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent"
            >
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-zinc-800 rounded-lg">
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-white">Auto-compound Rewards</p>
              <p className="text-xs text-gray-500 dark:text-zinc-500">Automatically stake rewards to increase earnings</p>
            </div>
            <button
              onClick={() => setAutoCompound(!autoCompound)}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                autoCompound ? 'bg-blue-600 dark:bg-blue-500' : 'bg-gray-300 dark:bg-zinc-600'
              }`}
            >
              <span
          ...
          <div className="border-t border-gray-200 dark:border-zinc-800 pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {[
                ...
                <div key={stake} className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg p-3">
