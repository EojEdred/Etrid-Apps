...
export default function MonitoringChart({
  ...
  const CustomTooltip = ({ active, payload, label }: any) => {
    if (active && payload && payload.length) {
      return (
        <div className="bg-slate-800/95 dark:bg-zinc-900/95 backdrop-blur-lg border border-white/20 dark:border-zinc-700 rounded-lg p-3">
          <p className="text-sm text-gray-300 dark:text-zinc-300 mb-1">{label}</p>
  ...
  return (
    <div className="bg-white/10 dark:bg-zinc-900/50 backdrop-blur-lg rounded-xl p-6 border border-white/20 dark:border-zinc-800">
