...
export default function NFTMarketplaceScreen({navigation}: any) {
  return (
    <LinearGradient colors={[colors.gradientStart, colors.gradientEnd]} style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>NFTMarketplace</Text>
        <View style={{width: 24}} />
      </View>
      <View style={styles.content}>
        <Text style={styles.text}>NFTMarketplace screen coming soon...</Text>
      </View>
    </LinearGradient>
  );
}
