...
export default function NFTDetailScreen({navigation}: any) {
  return (
    <LinearGradient colors={[colors.gradientStart, colors.gradientEnd]} style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>NFTDetail</Text>
        <View style={{width: 24}} />
      </View>
      <View style={styles.content}>
        <Text style={styles.text}>NFTDetail screen coming soon...</Text>
      </View>
    </LinearGradient>
  );
}
